...
Stop-AzureVM -ServiceName $webService -Name $webVM1Name -Force
Stop-AzureVM -ServiceName $webService -Name $webVM2Name -Force

Stop-AzureVM -ServiceName $plmService -Name $plmVM1Name -Force
Stop-AzureVM -ServiceName $plmService -Name $plmVM2Name -Force
Stop-AzureVM -ServiceName $plmService -Name $plmVM3Name -Force

Stop-AzureVM -ServiceName $pubService -Name $pubVM1Name -Force
Stop-AzureVM -ServiceName $pubService -Name $pubVM2Name -Force

Stop-AzureVM -ServiceName $dbService -Name $dbVM1Name -Force
Stop-AzureVM -ServiceName $dbService -Name $dbVM2Name -Force


### REMOVE ALL ###
#Remove-AzureVM -ServiceName $webService -Name $webVM1Name -DeleteVHD
#Remove-AzureVM -ServiceName $webService -Name $webVM2Name -DeleteVHD

#Remove-AzureVM -ServiceName $plmService -Name $plmVM1Name -DeleteVHD
#Remove-AzureVM -ServiceName $plmService -Name $plmVM2Name -DeleteVHD
#Remove-AzureVM -ServiceName $plmService -Name $plmVM3Name -DeleteVHD

#Remove-AzureVM -ServiceName $pubService -Name $pubVM1Name -DeleteVHD
#Remove-AzureVM -ServiceName $pubService -Name $pubVM2Name -DeleteVHD

#Remove-AzureVM -ServiceName $dbService -Name $dbVM1Name -DeleteVHD
#Remove-AzureVM -ServiceName $dbService -Name $dbVM2Name -DeleteVHD

Remove-AzureService -ServiceName $webService -Confirm -DeleteAll -Force
Remove-AzureService -ServiceName $plmService -Confirm -DeleteAll -Force
Remove-AzureService -ServiceName $pubService -Confirm -DeleteAll -Force
Remove-AzureService -ServiceName $dbService -Confirm -DeleteAll -Force